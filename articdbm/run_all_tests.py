...
def run_python_tests():
    ...
    # Test files to run
    python_tests = [
        "services/manager/test_comprehensive_database_management.py",
        "services/manager/test_comprehensive_sql_security.py", 
        "services/manager/test_shell_protection.py",
        "services/manager/test_default_blocking.py",
        "services/manager/test_security_integration.py",
        "services/manager/test_api_security.py",
        "services/manager/test_edge_cases_attacks.py",
        # Existing tests
        "services/manager/test_security_validation.py",
        "services/manager/test_database_management.py",
        "services/manager/test_blocking_system.py"
    ]
