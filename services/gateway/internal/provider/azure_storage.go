...
func (p *AzureStorageProvisioner) ProvisionBlockVolume(ctx context.Context, cfg kprovider.ExternalProviderConfig, spec kprovider.BlockVolumeSpec) (*kprovider.BlockVolumeInfo, error) {
...
func (p *AzureStorageProvisioner) DeprovisionBlockVolume(ctx context.Context, cfg kprovider.ExternalProviderConfig, volumeID string) error {
	subscriptionID := cfg.Extra["subscriptionId"]
	resourceGroup := cfg.Extra["resourceGroup"]
...
func (p *AzureStorageProvisioner) GetBlockVolumeStatus(ctx context.Context, cfg kprovider.ExternalProviderConfig, volumeID string) (*kprovider.BlockVolumeInfo, error) {
	subscriptionID := cfg.Extra["subscriptionId"]
	resourceGroup := cfg.Extra["resourceGroup"]
	if subscriptionID == "" || resourceGroup == "" {
...
func (p *AzureStorageProvisioner) ProvisionObjectBucket(ctx context.Context, cfg kprovider.ExternalProviderConfig, spec kprovider.ObjectBucketSpec) (*kprovider.ObjectBucketInfo, error) {
	subscriptionID := cfg.Extra["subscriptionId"]
	resourceGroup := cfg.Extra["resourceGroup"]
...
func (p *AzureStorageProvisioner) DeprovisionObjectBucket(ctx context.Context, cfg kprovider.ExternalProviderConfig, bucketName string) error {
	subscriptionID := cfg.Extra["subscriptionId"]
	resourceGroup := cfg.Extra["resourceGroup"]
	storageAccountName := cfg.Extra["storageAccountName"]
	if subscriptionID == "" || resourceGroup == "" || storageAccountName == "" {
