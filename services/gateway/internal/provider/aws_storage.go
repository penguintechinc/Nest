...
func (p *AWSStorageProvisioner) ProvisionBlockVolume(ctx context.Context, cfg kprovider.ExternalProviderConfig, spec kprovider.BlockVolumeSpec) (*kprovider.BlockVolumeInfo, error) {
...
func (p *AWSStorageProvisioner) createEBSVolume(ctx context.Context, cfg kprovider.ExternalProviderConfig, region, volumeType string, sizeGB int64, spec kprovider.BlockVolumeSpec) (string, error) {
...
func (p *AWSStorageProvisioner) DeprovisionBlockVolume(ctx context.Context, cfg kprovider.ExternalProviderConfig, volumeID string) error {
	region := cfg.Region
	if region == "" {
...
func (p *AWSStorageProvisioner) GetBlockVolumeStatus(ctx context.Context, cfg kprovider.ExternalProviderConfig, volumeID string) (*kprovider.BlockVolumeInfo, error) {
	region := cfg.Region
	if region == "" {
...
func (p *AWSStorageProvisioner) ProvisionObjectBucket(ctx context.Context, cfg kprovider.ExternalProviderConfig, spec kprovider.ObjectBucketSpec) (*kprovider.ObjectBucketInfo, error) {
	region := cfg.Region
	if region == "" {
		region = "us-east-1"
	}
...
func (p *AWSStorageProvisioner) createS3Bucket(ctx context.Context, cfg kprovider.ExternalProviderConfig, region, bucketName string) error {
	var endpoint string
	var body io.Reader
	if region == "us-east-1" {
...
func (p *AWSStorageProvisioner) putBucketVersioning(ctx context.Context, cfg kprovider.ExternalProviderConfig, region, bucketName string) error {
...
func (p *AWSStorageProvisioner) putBucketEncryption(ctx context.Context, cfg kprovider.ExternalProviderConfig, region, bucketName, encType, kmsKeyID string) error {
...
func (p *AWSStorageProvisioner) putPublicAccessBlock(ctx context.Context, cfg kprovider.ExternalProviderConfig, region, bucketName string) error {
...
func (p *AWSStorageProvisioner) DeprovisionObjectBucket(ctx context.Context, cfg kprovider.ExternalProviderConfig, bucketName string) error {
	region := cfg.Region
	if region == "" {
		region = "us-east-1"
	}
