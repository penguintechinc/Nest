...
func (p *GCPStorageProvisioner) ProvisionBlockVolume(ctx context.Context, cfg kprovider.ExternalProviderConfig, spec kprovider.BlockVolumeSpec) (*kprovider.BlockVolumeInfo, error) {
...
func (p *GCPStorageProvisioner) DeprovisionBlockVolume(ctx context.Context, cfg kprovider.ExternalProviderConfig, volumeID string) error {
	projectID := cfg.Extra["projectId"]
	zone := cfg.Extra["zone"]
	if projectID == "" || zone == "" {
...
func (p *GCPStorageProvisioner) GetBlockVolumeStatus(ctx context.Context, cfg kprovider.ExternalProviderConfig, volumeID string) (*kprovider.BlockVolumeInfo, error) {
	projectID := cfg.Extra["projectId"]
	zone := cfg.Extra["zone"]
	if projectID == "" || zone == "" {
...
func (p *GCPStorageProvisioner) ProvisionObjectBucket(ctx context.Context, cfg kprovider.ExternalProviderConfig, spec kprovider.ObjectBucketSpec) (*kprovider.ObjectBucketInfo, error) {
	projectID := cfg.Extra["projectId"]
	if projectID == "" {
...
func (p *GCPStorageProvisioner) DeprovisionObjectBucket(ctx context.Context, cfg kprovider.ExternalProviderConfig, bucketName string) error {
